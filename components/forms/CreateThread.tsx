...
import { TThreadSchema, ThreadSchema } from "@/lib/validations/thread";
...
const CreateThread = ({ link, isActive, userData, from }: Props) => {
  ...
  const handleSubmit = async (e: React.SyntheticEvent) => {
    ...
    const draftThread = target.thread_text.value;
      ...
      <DialogContent className="sm:max-w-[620px] outline-none border-0 bg-transparent">
        ...
        >
          ...
          <div className="flex justify-between items-end">
            ...
            <button
              type="submit"
              className={`text-dark-1 text-base-semibold  py-3 px-4 rounded-full mt-2 ${
                val.length > 0
